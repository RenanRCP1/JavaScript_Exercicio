function controllercalculo() {
    ...
    var error = validarcalc(operacao, valor1, valor2);
    if (error != "") {
        //alert(error);
    ...
    var resultdado = calculoResultado(operacao, valor1, valor2,)

    saidaDados(resultdado);

}

function validarcalc(operacao, valor1, valor2) {
    var error = "";
...
function calculoResultado(operacao = 0, valor1 = 0, valor2 = 0,) {
    if (operacao == 1) {
